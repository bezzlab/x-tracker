...
public class xLcMsCorr {
     ...
     * @param labelVal a string representing the experimental conditions associated to the peak.
    ...
    public xLcMsCorr(float mzVal, float intensityVal, String labelVal, float rtVal) {
        ...
        modificationName = new ArrayList<String>();
    ...
    public String getModificationNameAtIndex(int index) {
        if (index > -1 && index < modificationName.size()) {
            return modificationName.get(index);
        }
        return null;
    }
     ...
     * @see xLoad
     */
    private List<String> modificationName;
    /**
