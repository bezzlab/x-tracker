...
//        for (int i = 0; i < xTracker.xTracker.data.getDataSize(); i++) {
//
////          TODO:  xLoadData data = input.getDataElemAt(i); //selects data from one filename
//            xLoadData data = new xLoadData(""); //selects data from one filename
//
