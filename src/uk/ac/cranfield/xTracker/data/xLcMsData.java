...
public class xLcMsData implements Comparable<xLcMsData> {
    ...
    /**
     * Since lcMsData in xLoad data is ordered by Retention time, xLcMsData has to implement the comparable interface.
     * The compareTo method has therefore to be specified.
     ...
     */
    public void setSpectrum(xSpectrumList spec) {
        spectrum = spec;
    }
    /**
     * Retention Times
