...
public class xTracker {
    ...
    public static HashMap<String,MzMLUnmarshaller> unmarshallers = new HashMap<String,MzMLUnmarshaller>();
...
//        ParamList analysisSummary = mzQuantML.getAnalysisSummary();
//        //AnalysisSummary is optional though mandotary for xTracker
//        if(analysisSummary == null){
//            System.out.println("AnalysisSummary element is missing which is supposed to contain pipeline type and quantitation level flags");
//            System.exit(1);
//        }
...
//                System.out.println("Name:"+cvParam.getName()+" Value: "+cvParam.getValue()+" Accession:"+cvParam.getAccession());
...
//        System.out.println(study.getQuantitationFlag());
...
//                System.out.println("step: "+step);
                ...
                System.out.println("step "+step+": plugin "+pluginName+" with parameter file "+pluginParam);
                if(pluginName.length()>0) manager.setPlugin(step, pluginName, pluginParam);
            }
        }
...
//        System.out.println(rawFileGroups.size());
        ...
        //study variable list which is mandatory
//        for(StudyVariable qsv:mzQuantML.getStudyVariableList().getStudyVariable()){
//            xStudyVariable sv;
//        };
//        System.exit(0);
   }
