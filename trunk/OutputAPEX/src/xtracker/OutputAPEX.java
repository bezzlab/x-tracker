...
/**
 * Plugin to display the results of a quantification with the spectral counting APEX
 * method.
 * It displays first a window with the list of proteins and their APEX score.
...
public class OutputAPEX implements outPlugin
{
        ...
        public String getDescription()
    {
      ...
      */ 
    private final static String name = "OutputAPEX";
    ...
    private final static String type = "OUTPUT_plugin";
      ...
      */    
    private final static String description = "Plugin to display the results of a quantification with the spectral counting APEX method."+
                                                "It displays first a window with the list of proteins and their APEX score."+
                                                 "If the user click on a protein, it opens a window with the list of peptides and their"+
                                                "modifications.";
}
