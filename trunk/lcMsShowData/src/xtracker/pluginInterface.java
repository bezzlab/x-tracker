package xtracker;
         ...
         * <li>stop (returns true if everything went ok). Stops the plugin's execution.</li>
         * <li>getName (returns a string with the plugin name).</li>
         * <li>getVersion (returns a string with the plugin's version).</li>
         * <li>getType (returns a string with the plugin's type). There are 4 possible types of
         *     plugins:</li>
         *      <ol>
         *       <li> LoadPlugin (type string: LOAD_plugin)</li>
