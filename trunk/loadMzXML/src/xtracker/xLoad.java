...
public class xLoad {
    ...
    public xLoadData getDataElemAt(int index){
     ...
     /**
      * isValid checks the validity of the xLoad data structure.
      * <p>
      * xLoad data structure is valid if all the following conditions are met:
      * <ul>
      *     <li>The parameter file <code>parameterFile</code>is not empty  and it is an .xml file.</li>
      *     <li>The xLoadData structure is valid.</li>
      * </ul> 
     ...
     public boolean isValid(){
        ...
        for(int i=0;i<this.getDataSize();i++){
            tmp=this.getDataElemAt(i);
             check_data= (check_data) && tmp.isValid();
        }
