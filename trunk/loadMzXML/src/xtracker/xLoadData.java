...
public class xLoadData {
    ...
    public void setFileName(String file){
     ...
     public void addLcMsData(float rt, xSpectrum spec){
         ...
         * @see xLcMsMsElem
         */
     public void addMsMsData(float rtValue, float parentIonMzValue, int chargeVal, xSpectrum spec){
    ...
    public identInputData getIdentInputDataElemAt(int index){
     ...
     /**
      * isValid checks the validity of the xLoadData structure.
      * <p>
     ...
     public boolean isValid(){
        ...
        return check_file && (check_lcms_data ||check_msms_data) && check_identification_data; 
     
     }
     
     /**
      * Retrieves all the identifications of a particular peptide id.
      * @param pepId is the peptide id identifications are related to.
      * @return Vector<identInputData> the vector of identifications related to peptide having id pepId.
      * @see identInputData
      */
     public Vector<identInputData> getAllIdentOfPeptideId(String pepId){
        ...
        for(i=0;i<this.getIdentificationDataSize();i++){
            ...
            if(tmpElem.getPeptideId().equals(pepId)){
                ret.add(tmpElem);
            }
