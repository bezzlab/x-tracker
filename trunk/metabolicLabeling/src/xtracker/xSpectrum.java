...
public class xSpectrum {
     ...
     * res[i][0] is the mz value of the (i+1)-th peak having mz values between lower and upper.<br>
     * res[i][1] is the intensity value of the (i+1)-th peak having mz values between lower and upper.<br>
     */
