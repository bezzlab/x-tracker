package uk.ac.cranfield.xTracker.plugins.peakSelection;
...
//import xTracker.data.Modification;
//import xTracker.utils.XMLparser;
//
//public class metLabelingPeakSel implements peakSelPlugin {
//
////    public xPeaks start(Object data, String paramFile) {
////    public Data start(Object data, String paramFile) {
////        return start((Data)data,paramFile);
////    }
//    /**
//     * Loads amino acid mass shifts as well as n-terminus and c-terminus ones. After this it reads in MS/MS identification data loaded into xLoad structure.
...
//     */
////    public xPeaks start(Data input, String paramFile) {
////    public Data start(Data input, String paramFile) {
...
//        for (i = 0; i < xTracker.xTracker.data.getDataSize(); i++) {
//            identInputData myMsMsVals;
////          TODO:  xLoadData myLoadData = input.getDataElemAt(i);
//            xLoadData myLoadData = new xLoadData("");
...
//                            double tModShift = myXidentData.getTotalModificationMassShift();
...
//                                List<Modification> mods = myXIdntDt.getAllModifications();
//
...
//    }
//
//    public void computePeakCorrespondences(String type, String pepSeq, String pepId, float pMz, int pepCharge, float rt, xCorrespondenceData peaksCorr, xLoadData data, List<Modification> mods) {
...
//
//            for (int kk = 0; kk < mods.size(); kk++) {
//                Modification myMod = mods.get(kk);
//                String modName = myMod.getName();
//                int position = myMod.getPosition();
//                myCorr.addModification(modName, position);
//            }
