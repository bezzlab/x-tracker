...
public class sumIntMetLab implements quantPlugin
{
    ...
    private final static String name = "ComputeLcMsSumIntMetLab";
    private final static String version = "1.0";
    private final static String type = "QUANT_plugin";
    private final static String description = "\tThis plugin reads in XIC peak correspondences and computes the area in the time domain.";
}