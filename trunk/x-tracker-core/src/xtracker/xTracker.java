...
public class xTracker {
   ...
   * </pre>
    ...
    public static void printHtmlHelp(String descPath){
        ...
        htmlPage+="X-Tracker has been developed in the Bioinformatics Group of Cranfield University, UK.<br>Please remember to update this page whenever a new plugin is installed by calling:<br>java -jar xTracker.jar</td><td style=\"text-align: right; height: 100%; width: 39%; vertical-align: top;\"><img style=\"width: 400px;\" alt=\"xTracker\" src=\"img/XtrackerLogo.png\"></td><tr><td style=\"width: 30px; background-color: rgb(51, 102, 255); vertical-align: top;\">&nbsp;</td><td style=\"width: 7px;\">&nbsp;</td><td colspan=\"2\"><br><br><h2>Plugin parameter pages</h2>\n\t\t";
